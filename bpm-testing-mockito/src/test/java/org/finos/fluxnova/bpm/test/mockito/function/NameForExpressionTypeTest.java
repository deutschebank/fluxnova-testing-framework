...
import static org.finos.fluxnova.bpm.test.mockito.function.NameForType.juelNameFor;
...
public class NameForExpressionTypeTest {
  ...
  public void gets_name_for_mock_byClass() throws Exception {
    assertThat(juelNameFor(mock(NamedBean.class))).isEqualTo("namedBean");
  }

  @Test
  public void gets_name_for_mock_byAnnotation() throws Exception {
    assertThat(juelNameFor(mock(BarNamedBean.class))).isEqualTo("bar");
  }
