...
public class DelegateCaseVariableInstanceFakeTest {
  ...
  private final DelegateCaseVariableInstanceFake fake = FluxnovaMockito.delegateCaseVariableInstanceFake();

  private final DelegateCaseExecutionFake caseExecution = FluxnovaMockito.delegateCaseExecutionFake();
